...
// Replace existing scroll event listeners with throttled version
window.addEventListener('scroll', throttledScroll);

// Profile image handling - try to load real photo first, fallback to placeholder
document.addEventListener('DOMContentLoaded', () => {
    const profileImg = document.getElementById('profile-img');
    if (profileImg) {
        // First try to load a real profile photo
        const realPhoto = new Image();
        realPhoto.onload = function() {
            // Real photo exists, use it
            profileImg.src = 'assets/profile.jpg';
            profileImg.style.objectFit = 'cover';
        };
        realPhoto.onerror = function() {
            // Real photo doesn't exist, stick with SVG placeholder
            console.log('📷 Using SVG placeholder - Add your photo as assets/profile.jpg to replace it');
        };
        realPhoto.src = 'assets/profile.jpg';
    }
});
